namespace Tests.Modules.KWMODULENAME.Static.Helpers
{
	/// <summary>
	/// Trait name constants for categorising KWMODULENAME module tests.
	/// <para>
	...
	/// <c>dotnet test --filter "Capability=Examples"</c>,
	/// <c>dotnet test --filter "Quality=Reliability.Maturity"</c>
	/// </para>
	/// <para>
	/// NOTE: an identical copy of this file exists in
	/// <c>Tests.Modules.KWMODULENAME.Dynamic</c>. Keep the two in sync.
	/// </para>
	/// </summary>
	public static class TestTraits
	{
		...
		{
			/// <summary>Template example domain (replace with real capabilities).</summary>
