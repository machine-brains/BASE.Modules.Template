...
namespace App.Modules.KWMODULENAME.Application.Domains.Examples.Maps
{
    ...
    /// <remarks>
    /// <para>
    /// Cannot use <c>MapReferenceData()</c> because it requires both sides to implement
    /// <c>IHasReferenceData</c>, which includes infrastructure contracts
    /// (Timestamp, RecordState, Audit) that <c>ReferenceDataBaseDto</c>
    /// intentionally omits.
    /// </para>
    /// </remarks>
