...
{
    /// <summary>
    /// Reverse map: <see cref="ExampleTypeReadDto"/> to <see cref="ExampleType"/> entity.
    ...
    /// </para>
    /// </remarks>
    public class ExampleTypeDtoToExampleTypeMap : ObjectMapBase<ExampleTypeReadDto, ExampleType>
    {
        /// <inheritdoc/>
        protected override void ConfigureMapping()
        {
            ...
            this.CreateMap()
                ...
                .MapDisplayHint()
                .MapKey()
                .MapFrom(dest => dest.RecordMutability, src => (RecordMutabilityType)src.ReferenceDataType);
        }
    }
}
